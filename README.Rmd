...
Chen, J. (2020). LAWBL: Latent (variable) analysis with Bayesian learning (R package version 1.3.0). Retrieved from [https://CRAN.R-project.org/package=LAWBL](https://CRAN.R-project.org/package=LAWBL)
...
*Structural Equation Modeling: A Multidisciplinary Journal*. DOI: 10.1080/10705511.2020.1854763.
