...
Currently, this package includes the Partially Confirmatory Factor Analysis (PCFA), a partially confirmatory approach covering a wide range of the exploratory-confirmatory continuum in factor analytic models. The PCFA (Chen, Guo, Zhang, & Pan, 2020) is only for continuous data, while the generalized PCFA (GPCFA) covers both continuous, categorical, or mixed-type data.
...
For examples of how to use the package, see vignettes or [here](https://jinsong-chen.github.io/LAWBL/articles/pcfa-examples.html) for PCFA with continuous data;
[here](https://jinsong-chen.github.io/LAWBL/articles/gpcfa-examples.html) for GPCFA with categorical data.
