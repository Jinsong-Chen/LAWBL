...
Q
m0<-pcirm(dat = dat,Q=  Q,LD = TRUE,cati = -1,burn = 2000,iter = 2000,update = 1000,verbose = TRUE)
summary(m0)
...
m1<-pcirm(dat = dat,Q=  Q,LD = FALSE, cati = -1,burn = 4000,iter = 4000,update = 1000,verbose = TRUE)
summary(m1)
...
m2<-pcirm(dat = dat,Q=  Q,LD = TRUE,cati = -1,burn = 4000,iter = 4000,update = 1000,verbose = TRUE)
summary(m2)
