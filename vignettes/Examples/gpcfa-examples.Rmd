...
2) **E-step:** Estimate with the GPCFA-LI model (E-step) by setting *LD=FALSE*. Only a few loadings need to be specified in Q (e.g., 3 per factor). The first 6 items are categorical and need to be specified with *cati*.
